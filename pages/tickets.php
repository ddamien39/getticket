...
if (is_null($currUser)) {
    Header("Location: /form/sign_up.php");
}
...
<head>
    ...
    <script>
        function setTicketParam(arg1) {
            const url = new URL(window.location.href);
            url.searchParams.set('ticketid', arg1);
            ...
            <div class="leftside bg-slate-800">
                ...
                <div class="personal-user-card bg-slate-700">
                    ...
                    <div class="user-combo">
                        <p class="username text-blue-300"><?php echo $currUser["username"] ?></p>
                        <p class="rank text-red-500"><?php echo $rankName ?></p>
                    </div>
                </div>
